...
import { Modal, Form, Select, Input, Button, Space, Divider, Row, Col, InputNumber, Alert, Tooltip, Typography } from 'antd';
...
interface AdjustModalProps {
  open: boolean;
  onClose: () => void;
  onSubmit: (values: AdjustRequest) => void;
  submitting: boolean;
  targetWarehouseId: string;
  warehouseCode: string;
}

const AdjustModal: React.FC<AdjustModalProps> = ({ open, onClose, onSubmit, submitting, targetWarehouseId, warehouseCode }) => {
