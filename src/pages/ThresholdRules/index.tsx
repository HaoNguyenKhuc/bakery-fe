...
import {
  ...
  RightOutlined, TeamOutlined, EditOutlined, ThunderboltOutlined
    ...
    <div className="pp-page">
      <div className="pp-header">
        <div className="pp-header__left">
          ...
          <div>
            <h1 className="pp-header__title">Threshold Rules</h1>
            <p className="pp-header__sub">Quản lý quy tắc cảnh báo & sản xuất</p>
          </div>
        </div>
      </div>
